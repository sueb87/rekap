...
<head>
    ...
    <title><?php echo $title ?> | Rekap</title>
    <!-- Bootstrap -->
        ...
        <div class="main_container">
            <div class="col-md-3 left_col menu_fixed">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="dashboard" class="site_title"><i class="fa fa-file-o"></i> <span>Rekap TA</span></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li>
                                    <a href="<?php echo base_url()?>anggota"><i class="fa fa-columns"></i> Rekap</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url()?>buku"><i class="fa fa-minus"></i> Pengeluaran</a>
                                </li>
                                <?php if($this->session->userdata('role') == 'superadmin'): ?>
                                <li>
                                    <a href="<?php echo base_url()?>petugas"><i class="fa fa-file-excel-o"></i> Optima</a>
                                </li>
                                <?php endif;?>
                            </ul>
                        </div>
                        ...
                        <?php if($this->session->userdata('role')=='superadmin'): ?>
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    <li>
                                        <a href="<?php echo base_url()?>transaksi"><i class="fa fa-print"></i> Print Rekap</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url()?>notification"><i class="fa fa-print"></i> Print Optima</a>
                                    </li>
                                </ul>
                            </div>
                        <?php endif; ?>
            ...
            <footer>
                <div class="pull-right">
                    Notebook v0.1 Alpha | Copyright Software
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
